...
```{r, eval = TRUE}
dataGRN <- GRN(TFs = rownames(DEGsmatrix)[1:5], normCounts = dataFilt,
...
### Introduction 
This vignette shows a complete workflow of the 'MoonlightR' package. Everything but the data download.
...
```{r, eval = TRUE,message=FALSE,warning=FALSE, results='hide'}
 plotURA(dataURA = dataURA[c(names(dataDual$TSG), names(dataDual$OCG)),, drop = FALSE], plotNAME = "URAplot")
 ```
