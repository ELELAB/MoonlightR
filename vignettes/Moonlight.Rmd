...
```{r, eval = FALSE}
#library(devtools)
#install_github("torongs82/Moonlight/tree/master/MoonlightR")
...
BPannotations <- DiseaseList[[which(names(DiseaseList) == BPselected)]]$ID
...
A results from LPA is shown below:

```{r, eval = TRUE, echo = FALSE}
knitr::kable(DiseaseList[[1]][1:10,c(1,3:5)], digits = 2, 
             caption = "Table LPA",
             row.names = FALSE)
```
